...
//	デフォルトコンストラクタ
//------------------------------------------------------------------------------
CDXGraphics9::CDXGraphics9() : m_pD3D(NULL), m_pD3DDevice(NULL), m_pD3DDevice9on12(NULL),
...
//	m_pD3D = ::Direct3DCreate9(D3D_SDK_VERSION);
	...
	if (m_pD3DDevice->QueryInterface(__uuidof(IDirect3DDevice9On12), (void**)&m_pD3DDevice9on12) != S_OK) {
		::OutputDebugString(TEXT("*** Error - Direct3Dvice9on12オブジェクト取得失敗(CDXGraphics9_Initialize)\n"));
		Release();
		return false;
	}
